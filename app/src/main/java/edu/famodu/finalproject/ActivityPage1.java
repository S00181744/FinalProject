...
public class ActivityPage1 extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGreen = findViewById(R.id.btnLeft);
        btnRed = findViewById(R.id.btnTop);
        btnBlue = findViewById(R.id.btnRight);
        btnYellow = findViewById(R.id.btnBottom);
