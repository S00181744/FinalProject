package edu.famodu.finalproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnPlay, btnExit, bRed, bBlue, bYellow, bGreen, fb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addHiScore(new HiScore("20 OCT 2020", "Michonne", 12));
        db.addHiScore(new HiScore("28 OCT 2020", "Rick", 16));
        db.addHiScore(new HiScore("20 NOV 2020", "Daryl", 20));
        db.addHiScore(new HiScore("20 NOV 2020", "Maggie", 18));
        db.addHiScore(new HiScore("22 NOV 2020", "Carl", 22));
        db.addHiScore(new HiScore("30 NOV 2020", "Glenn", 30));
        db.addHiScore(new HiScore("01 DEC 2020", "Carol", 22));
        db.addHiScore(new HiScore("02 DEC 2020", "Rosita", 132));
        ...
        if (hiScore.getScore() < myCurrentScore) {
            db.addHiScore(new HiScore("08 DEC 2020", "Judith", 40));
        }
